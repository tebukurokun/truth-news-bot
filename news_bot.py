...
def publish():
    ...
    for article in nhk_updated_articles:
        ...
        try:
            ...
            logger.warning(f"Failed NHK article: {article.title} error: {e}")
            continue
        finally:
            time.sleep(10)
    ...
    for article in asahi_sankei_updated_articles:
        ...
        try:
            ...
            logger.warning(f"Failed asahi sankei article: {article.title} error: {e}")
            continue
        finally:
            time.sleep(10)
    ...
    for article in bbc_updated_articles:
        ...
        try:
            ...
            logger.warning(f"Failed BBC article: {article.title} error: {e}")
            continue
        finally:
            time.sleep(10)
    ...
    for article in cnn_updated_articles:
        ...
        try:
            ...
            logger.warning(f"Failed CNN article: {article.title} error: {e}")
            continue
        finally:
            time.sleep(10)
